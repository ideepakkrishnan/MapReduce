 ...
 * their average with synchronization on the data structure
 * that stores the processed data.
 * @author ideepakkrishnan
 */
public class CoarseLockCalculator implements Runnable {
	
	private static final Logger logger = LogManager.getLogger(
			CoarseLockCalculator.class.getName());
